...
class App extends Component {
  constructor(props) {
    ...
    // this.validateWeekendDate=this.validateWeekendDate(this);
  }
...
console.log("interval "+interval);
      ...
      for (var i = 1; i <= checkpointInterval; i++) {
        // if (i == 1) {
          console.log(i);
          ...
          checkpointInputDate.setDate(new Date(this.state.startDate).getMonth() + checkpointIntData);
